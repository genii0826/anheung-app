...
const COL = {
  bg0: "#F1F5F9",      // 부드럽고 시원한 느낌의 베이스 배경
  bg1: "#E2E8F0",      // 배경 그라데이션용 약간 짙은 톤
  panel: "#FFFFFF",    // 카드 배경
  panelHi: "#F8FAFC",  // 버튼 및 표 헤더 (은은한 구분감)
  line: "#E2E8F0",     // 너무 거슬리지 않는 연한 테두리
  lineSoft: "#F1F5F9", // 내부 보조선
  text: "#1E293B",     // 완전 검은색이 아닌, 고급스러운 짙은 네이비그레이
  mut: "#64748B",      // 설명 텍스트
  mut2: "#94A3B8",     // 가장 작은 부가 정보
  heat: "#F43F5E",     // [개선] 쨍한 빨강 대신 세련된 코랄/로즈 레드 (눈이 편안함)
  heatSoft: "#FFE4E6", // 온도 배경 효과 (은은한 핑크빛)
  raw: "#475569",      // 원시 데이터 
  aqua: "#0EA5E9",     // [개선] 탁한 파랑 대신 맑고 산뜻한 스카이블루
  sage: "#10B981",     // [개선] 부드러운 에메랄드 그린
  thi: [
    "#0EA5E9", // 0: 낮음 (맑은 파랑)
    "#10B981", // 1: 보통 (에메랄드 그린)
    "#F59E0B", // 2: 높음 (눈 안 아픈 따뜻한 호박색)
    "#F43F5E", // 3: 매우 높음 (코랄 레드)
  ],
};
